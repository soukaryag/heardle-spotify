...
const PlayV2 = props => {
    ...
    const [tracks,
        setTracks] = useState([]);
    const [artist,
        setArtist] = useState(null);
    const [playing,
        setPlaying] = useState(false);
    const [currentTrack,
        setCurrentTrack] = useState(null);
    const [deviceId,
        setDeviceId] = useState(null);
    const [devicesAvailable,
        setDevicesAvailable] = useState([]);
    const [statsForArtist,
        setStatsForArtist] = useState({});
    const [gradientColor, setGradientColor] = useState(colors.green)

    const timeLimitsArray = [
        1500,
        2000,
        4000,
        8000,
    ...
    const [displayedTracks,
        setDisplayedTracks] = useState(null);
    const [trackPlaying,
        setTrackPlaying] = useState(false);
    const [winner,
        setWinner] = useState(false);
    const [loser,
        setLoser] = useState(false);
                ...
                ? (
                    <PageContainer style={{
                        ...
                        <BannerHeader>
                            ...
                            <NavigationContainer>
                                <NavButtonContainer>
                                    <ButtonContainer onClick={e => window.history.go(-1)} style={{ marginRight: '10px' }}>
                                        <IconBack />
                                    </ButtonContainer>
                                    <ButtonContainer style={{ cursor: 'not-allowed', opacity: .6 }}>
                                        <IconForward />
                                    </ButtonContainer>
                                </NavButtonContainer>
                                <LinkContainer to={'/'}>
                        ...
                        <BodyContainer>
                            <ActionsContainer>
                                ...
                                <InfoButtonContainer onClick={e => console.log('Popup with how to play')} style={{ marginLeft: '15px' }}>
                                    <IconInfo />
                                </InfoButtonContainer>
                            </ActionsContainer>
                            <ContentContainer>
                                    ...
                                    <StatsParentContainer>
                                        <StatsContainer>
                                            <StatsCard
                                                ...
                                                label={'Wins'}
                                                icon={<IconTrophy />}
                                                subtext={<><span style={{ color: colors.green, marginRight: '3px', fontWeight: '600' }}>Top 0.005%</span> of all {artist.name} fans</>}
                                            />
                                            <StatsCard
                                                stat={32}
                                                label={'Losses'}
                                                icon={<IconLoss />}
                                                subtext={<><span style={{ color: colors.red, marginRight: '3px', fontWeight: '600' }}>Bottom 3%</span> of all {artist.name} fans</>}
                                            />
                                        </StatsContainer>
                                        <StatsContainer>
                                            <StatsCard
                                                ...
                                                label={'Attempts'}
                                                icon={<IconPlay />}
                                                subtext={<><span style={{ color: colors.green, marginRight: '3px', fontWeight: '600' }}>Top 1%</span> of all {artist.name} fans</>}
                                            />
                                            <StatsCard
                                                stat={4.2}
                                                label={'Average Guess'}
